...
6. **Nadpisania** — workerzy mogli pracować w tym samym katalogu bez izolacji,
   więc szukaj też zmian, które zniknęły: rzeczy opisanej w rejestrze jako
   zrobiona, a której w plikach nie widać.
