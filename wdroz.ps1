...
# Pomiar, ostrzezenie i czytanie sufitu siedza w narzedzia\sufit-ladunku.ps1,
# bo tego samego uzywa straznik przy samoaktualizacji. Stad: $OstrzezenieUciecia,
# Ostrzezenie-O-Ucieciu, Limit-Ladunku i Pilnuj-Sufitu.
. (Join-Path $Zrodlo "narzedzia\sufit-ladunku.ps1")
